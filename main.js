...
function canvas() {
  ...
  gsap.to(imageSeq, {
    ...
    ease: "none",
    scrollTrigger: {
      scrub: 0.15, //"true"도 가능 //스크롤 내리면 실행하고싶으면 필요
      trigger: "#page>canvas",
      start: "top top",
      end: "1000% top",
      scroller: "#main",
  ...
  ScrollTrigger.create({
    ...
    end: "1000% top", //애니메이션 종료 --> 600%내려가서 뷰포트의 top에 붙으면 애니메이션 종료
  });
}
...
gsap.to("#page6",{
    scrollTrigger:{
        trigger:"#page6", // 애니메이션이 시작될 요소
        scroller:"#main", //스크롤이 발생하는 요소
        pin:true, //스크롤하는 동안 트리거 요소(#page>canvas) 고정시킴
        start: "top -5%",//애니메이션 시작
        end: "bottom top",//애니메이션 종료 --> bottom이 top이 될 때
    }
})
...
// 2) 두번째 방법
// let imgEle = new Image() // 이미지태그 만들기 // new는 객체를 만드는 방법
// console.log(imgEle) //<img src="../img.jpg" alt="이미지설명">
// imgEle.src = "../img.jpg"
// imgEle.alt = "이미지설명"
...
/* 24.img_download > console에 있는 이미지 가져옴 */